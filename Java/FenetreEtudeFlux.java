...
public class FenetreEtudeFlux extends JFrame
{
...
//************************
	...
	class ClicSuivant implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			FenetreEtudeFlux2 fenetre = new FenetreEtudeFlux2(listeDesClassifications.getChoixDesClassifications(), listeDesNiveaux.getChoixDesNiveaux());
			fenetre.setVisible(true);
			dispose();
		}
	}
