...
public class BoiteACocherTerritoireFlux2 extends JFrame
{
...
//***********************
	private void init()
	{
		this.setTitle("\u00c9tude des flux entre territoires : Choix des territoires");
...
//************************
	...
	public void enregistrementCasesCochees()
	{
		...
		enregistrementTerritoire2 = new String[enregistrement.size()];
		for(int i = 0 ; i < enregistrement.size() ; ++i)
		{
			enregistrementTerritoire2[i] = codeISO[enregistrement.get(i)];
		}
		setEnregistrementTerritoire2(enregistrementTerritoire2);
	}
...
//				affichageSelection();
	...
	class ClicBoutonOK implements ActionListener
	{
		public void actionPerformed(ActionEvent e)
		{
			...
			{
				FenetreEtudeFlux2 renvoiDonnees = new FenetreEtudeFlux2(getChoixDesClassifications(), getChoixDesNiveaux(), getEnregistrementTerritoire(), getEnregistrementTerritoire2(), getAnneeDebut(), getAnneeFin());
