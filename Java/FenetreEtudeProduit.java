...
public class FenetreEtudeProduit extends JFrame
{
...
//************************
	...
	class ClicSuivant implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			FenetreEtudeProduit2 fenetre = new FenetreEtudeProduit2(listeDesClassifications.getChoixDesClassifications(), listeDesNiveaux.getChoixDesNiveaux());
			fenetre.setVisible(true);
			dispose();
		}
	}
