...
public class BoiteACocherTerritoireV3 extends JFrame
{
	private BaseAttributaireTerritoire2 baseAttributaireTerritoire = null;
	...
	public BoiteACocherTerritoireV3(String text, String text2)
	{
...
//		affichageFenetreTableau();
	...
	public BoiteACocherTerritoireV3(String text, String text2, int anneeDebut, int anneeFin)
	{
		//Récupération de la valeur de la classification
		setChoixDesClassifications(text);
		setChoixDesNiveaux(text2);
...
//******************************************
	...
	{
		baseAttributaireTerritoire = new BaseAttributaireTerritoire2(getChoixDesClassifications());
...
//*Getters et setters*
//********************
	public BaseAttributaireTerritoire2 getBaseAttributaireTerritoire()
	{
		return this.baseAttributaireTerritoire;
	}
	private void setBaseAttributaireTerritoire(BaseAttributaireTerritoire2 base)
	{
