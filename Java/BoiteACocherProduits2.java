...
public class BoiteACocherProduits2 extends JFrame
{
...
//***********************
	public BoiteACocherProduits2(String text, String text2, String[] text3, String[] text4, int anneeDebut, int anneeFin)
	{
		...
		donneesProduits();
		//Gestion de la fenêtre
		this.setTitle("\u00c9tude des flux entre territoires : Choix des produits");
...
//			affichageSelection();
	...
	class ClicBoutonOK implements ActionListener
	{
		public void actionPerformed(ActionEvent e)
		{
			...
			{
				FenetreEtudeFlux3 renvoiDonnees = new FenetreEtudeFlux3(getChoixDesClassifications(), getChoixDesNiveaux(), getTerritoire(), getTerritoire2(), getAnneeDebut(), getAnneeFin(), getEnregistrementProduit());
	...
	class Fermeture implements WindowListener
	{
		...
		{
			FenetreEtudeFlux3 renvoiDonnees = new FenetreEtudeFlux3(getChoixDesClassifications(), getChoixDesNiveaux(), getTerritoire(), getTerritoire2(), getAnneeDebut(), getAnneeFin());
			renvoiDonnees.setVisible(true);
			dispose();
		}
