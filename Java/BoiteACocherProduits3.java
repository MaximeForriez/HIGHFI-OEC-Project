...
public class BoiteACocherProduits3 extends JFrame
{
...
//***********************
	public BoiteACocherProduits3(String text, String text2, int anneeDebut, int anneeFin)
	{
		...
		donneesProduits();
		//Gestion de la fenêtre
		this.setTitle("\u00c9tude des types de produits : Choix des produits");
...
//			affichageSelection();
	...
	class ClicBoutonOK implements ActionListener
	{
		public void actionPerformed(ActionEvent e)
		{
			...
			{
				FenetreEtudeProduit2 renvoiDonnees = new FenetreEtudeProduit2(getChoixDesClassifications(), getChoixDesNiveaux(), getEnregistrementProduit(), CompareAnneeDebut.getAnneeDebut(), CompareAnneeFin.getAnneeFin());
	...
	class Fermeture implements WindowListener
	{
		...
		{
			FenetreEtudeProduit2 renvoiDonnees = new FenetreEtudeProduit2(getChoixDesClassifications(), getChoixDesNiveaux(), getAnneeDebut(), getAnneeFin());
			renvoiDonnees.setVisible(true);
			dispose();
		}
